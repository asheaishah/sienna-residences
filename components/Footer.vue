<template>
  <div class="py-6 text-center bg-gray-400">
          <div class="max-w-8xl px-4 py-6 mx-auto">
      <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
        <div class="space-y-2 flex flex-col items-center justify-center">
          ...
          <img
            src="@/assets/img/Sienna/Developer.png"
            alt="Tecktonic & Sons Holdings Sdn. Bhd."
            class="object-contain h-20"
          />
      
        </div>
        <div class="space-y-2 text-center">
          <h4 class="text-xl font-medium">Sienna Residence</h4>
          <ul class="space-y-3 text-gray-600">
            <li>Developer: Tecktonic & Sons Holdings Sdn. Bhd.</li>
            <li>Tenure of Land: Leasehold</li>
            <li>Land Size: 16.54 ACRES(APPROX.)</li>
          </ul>
        </div>
        ...
        <div class="space-y-2 text-center">
          ...
          <ul class="space-y-3 text-gray-600">
            <li>
              <NuxtLink to="/bridgelux-homes/phase-1" exact class="nuxt-link-exact-active nuxt-link-active">Poster</NuxtLink>
            </li>
            <li><NuxtLink to="/floor-plan">Floor Plan Sienna Residence</NuxtLink></li>
        ...
        <div class="space-y-2">
          ...
          <ul class="space-y-3 text-gray-600">
            ...
            <li class="flex items-center space-x-2">
              ...
              <a href="tel:+60178093305">+60178093305</a>
            </li>
            <li class="flex items-center space-x-2">
              <svg
                fill="none"
              ...
              <a href="mailto:siennaresidencekch@gmail.com">siennaresidencekch@gmail.com</a>
            </li>
            <li>
              <a href="https://goo.gl/maps/4dykforyGzm8rDZv9" target="_blank">Sienna Residence, Jalan Matang, Petra Jaya, 93050 Kuching, Sarawak</a>
              </li>
          </ul>
        </div>
      </div>
    ...
    <div class="py-6 text-center bg-black">
      <div class="max-w-6xl px-5 mx-auto space-y-3">
        <div class="text-sm text-white">
          <div class="flex flex-wrap justify-center max-w-4xl mx-auto divide-x divide-gray-500">
            <p class="px-1">Copyright © 2023</p>
            <p class="px-1">Sienna Residence</p>
            <p class="px-1">Tecktonic & Sons Holdings Sdn. Bhd</p>
            <p class="px-1"><a href="tel:+60178093305">+60178093305</a></p>
    ...
    <div class="header-chat">
      <div class="head-home">
        ...
        <p>
          <span class="whatsapp-name">Sienna Residence</span><br />
        ...
        <div class="WhatsappChat__MessageContainer-sc-1wqac52-1 dAbFpq">
          ...
          >
            ...
            <div class="WhatsappChat__Text-sc-1wqac52-2 iSpIQi">
              Thank you for expressing your interest in Sienna Residence👋<br /><br />How may I assist you today?
            </div>
